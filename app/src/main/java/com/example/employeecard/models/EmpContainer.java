...
public class EmpContainer {
    ...
    public EmpContainer() {
        ...
        EmployeeInfo card1 = new EmployeeInfo(R.drawable.emp_man_img,R.color.android,R.drawable.card_background_android, "Patrick Johannes","Rank 3 Android Developer",skillsAndroid);
        card1.setEmpDetail(empDetail);
        dataset.add(card1);
        EmployeeInfo card2 = new EmployeeInfo(R.drawable.emp_woman_img2,R.color.ios,R.drawable.card_backround_ios, "Veronika Zhangalova ","Rank 5 IOS Developer",skillsIos);
        card2.setEmpDetail(empDetail);
        dataset.add(card2);
        EmployeeInfo card3 = new EmployeeInfo(R.drawable.emp_man_img,R.color.front,R.drawable.card_background_front, "Samuel George Claflin","Rank 4 Front End Developer",skillsAndroid);
        card3.setEmpDetail(empDetail);
        dataset.add(card3);
        EmployeeInfo card4 = new EmployeeInfo(R.drawable.emp_woman_img2,R.color.back,R.drawable.card_background_back, "Farida Agzamova","Rank 5 Back End Developer",skillsAndroid);
