...
public class EmpDetail {
    private DateTime m_emp_work_start;
    private int m_emp_age;
    private String m_emp_email;
    private String emp_tel_number;

    public EmpDetail(DateTime m_emp_work_start, int m_emp_age, String m_emp_email, String emp_tel_number) {
    ...
    public DateTime getEmp_work_start() {
